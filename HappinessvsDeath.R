...
selected_data <- csv1[, c("Country", "Deaths", "Happiness.Score","Total.Pop")]
...
happy <- new_data[,c("Happiness.Score")]
happy1=happy[1:50]
...
png("~/BDA/2015dvh.png", width = 800, height = 600)
barplot(df, main = "Happiness and Death comparison", names.arg =place1,  
